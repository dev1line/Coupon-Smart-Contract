...
contract PoolFactory is Validatable, ERC165Upgradeable, IPoolFactory {
    ...
    function create(
        ...
        IStakingPool pool = IStakingPool(
            ClonesUpgradeable.cloneDeterministic(address(template), salt)
        );
    ...
    {
        return
            interfaceId == type(IPoolFactory).interfaceId ||
